...
/**
 * Servlet implementation class E_SearchingProductServlet
 */
@WebServlet("/searchingProduct")
public class E_SearchingProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public E_SearchingProductServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new E_ProductService().searchingProductCount(categoryNo, select, value, productStatus);
		limit = 10;
		...
		ArrayList<Product> productList = new E_ProductService().searchingProduct(pi, categoryNo, select, value, productStatus);

		ArrayList<Category> categoryList = new E_ProductService().selectCategory();
		
		
		int productCount = new E_ProductService().countProductList();
		...
		if(productList!=null) {
			...
			page="views/admin/productManagement/E_productSearchingPage.jsp";
		}else {
