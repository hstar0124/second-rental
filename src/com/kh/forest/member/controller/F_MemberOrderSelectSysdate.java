...
/**
 * Servlet implementation class F_MemberOrderSelectSysdate
 */
@WebServlet("/orderStatsSysdate.me")
public class F_MemberOrderSelectSysdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public F_MemberOrderSelectSysdate() {
        super();
