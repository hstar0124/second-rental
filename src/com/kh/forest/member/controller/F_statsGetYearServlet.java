...
/**
 * Servlet implementation class F_statsGetYearServlet
 */
@WebServlet("/getYear.me")
public class F_statsGetYearServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public F_statsGetYearServlet() {
        super();
