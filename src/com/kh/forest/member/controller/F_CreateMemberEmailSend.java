...
public class F_CreateMemberEmailSend extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public F_CreateMemberEmailSend() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// Subject
			message.setSubject("중고구마 이메일 인증번호 메일입니다.");
			...
			message.setText(str);
			message.setContent("<div style=' font-weight:bold; width:700px; height:562px; margin:0 auto;'>\r\n" + 
