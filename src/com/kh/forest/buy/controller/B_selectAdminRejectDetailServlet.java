...
/**
 * Servlet implementation class B_selectAdminRejectDetailServlet
 */
@WebServlet("/selectAdminRejectDetail.ad")
public class B_selectAdminRejectDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public B_selectAdminRejectDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BuyInfo buyinfo = new B_buyService().selectRequestDetailReject(buyNo);
		...
		if(buyinfo != null && fileList != null) {
			page = "views/admin/buyManagement/B_buydetailReject.jsp";
