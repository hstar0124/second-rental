...
/**
 * Servlet implementation class C_selectPurchaseList
 */
@WebServlet("/select.pur")
public class C_selectPurchaseList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public C_selectPurchaseList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<OrderStatus> list = new C_paymentService().selectList(pi);
		
		String page = "";
		if(list != null) {
			page = "views/admin/orderManagement/C_orderStatus.jsp";
