 ...
 */
@WebServlet("/selectList2.no")
public class D_SelectNoticeListServletUser extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public D_SelectNoticeListServletUser() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "";
		if(list1 != null) {
			page = "views/user/mypage/D_MyPageSection_notice.jsp";
