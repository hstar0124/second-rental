...
/**
 * Servlet implementation class D_SelectOneNoticeServletMain
 */
@WebServlet("/selectOneMain.no")
public class D_SelectOneNoticeServletMain extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public D_SelectOneNoticeServletMain() {
        super();
...
String num = request.getParameter("nboardNo");
		...
		String page = "";
		if(notice != null) {
			page = "views/user/mypage/D_NoticeDetail_Main.jsp";
