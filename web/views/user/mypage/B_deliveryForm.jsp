...
<h1 class="title">필요 정보 입력</h1>
        <div style="background-color: #6E00AB; width: 100%; height: 4px; margin-top: 0px;"></div>
        
     

        <div class="notice-area">
            <p><판매 신청 시 필수 확인 사항></p>
            <p>보내실 곳 : 서울특별시 강남구 테헤란로 14길 6 [06240]   받는 사람 : 이호성</p>
            <p>※ 배송 후 운송번호를 꼭 기입하셔야 물품 수령이 가능합니다. ※</p>
        </div>
        

            <div class="delivery-insert">            
                <p>| 운송장 번호 입력</p>
                
                <select id="carrier" name="carrier" class="insert-select">
                    <option >택배사선택</option>
                ...
                &nbsp;
                <input type="text" name="waybillNo" class="insert-no" value="">
        ...
        $(function(){
        	//회원 기본정보 주소 불러오기
     		...
     		$("#carrier").change(function(){
     			carrier = $(this).find(":selected").val();
     		...
     		$("#submitBtn").click(function(){
	     		...
	     		location.href = "<%=request.getContextPath()%>/insertBuyWaybill.buy?carrier=" + carrier +
	     				"&waybillNo=" + waybillNo + "&buyNoVal=" +<%=buyNoVal%> + "&address=" + arr;
     		});
