   ...
   <article id="waitRange1">
      <table class="resultTable">
        ...
        <% for(CashbackHistory c : waitList) { %> 
         <tr>
            <td class="resultTableTd"><input type="checkbox" class="reTbCheck" name ="historyNo" value="<%= c.getCashbackHistoryNo()%>"></td>
     ...
     <% if(pi != null){ %> 
      ...
      <div class="DDD">&nbsp;&nbsp;
         <button class="sendMail" id="printAll">일괄처리</button>
         <button class="sanction" id="print">EXCEL출력</button>
      </div>
   </article>
