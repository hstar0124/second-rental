	...
	<!------------------------ 사진 확인 ------------------------>
		...
		<div class="input-area">
			...
			<div class="delivery-area">
				<p><b>| 반송 운송장 번호</b></p>
				<% if(buyinfo.getDivision().equals("반송")) { %>
				
				<input type="text" name="deliveryNo" value="<%=buyinfo.getBuyWaybillNo() %>" readonly>  
				<% } else { %>
				<input type="text" name="deliveryNo" value="-" readonly>
				<% } %>
			</div>
		</div>
		...
		<div class="btn-area">
			...
			<button class="okBtn" id="sendOkBtn">확인</button>
		</div>
